...
//                .oauth2Login(Customizer.withDefaults())
    ...
    public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate,
        ...
        RegisteredClient knife4jClient = RegisteredClient
                .withId("knife4j-client")
                .clientId("knife4j-client")
        ...
        if (Objects.isNull(registeredClientRepository.findByClientId(knife4jClient.getClientId()))) {
            registeredClientRepository.save(knife4jClient);
        }
