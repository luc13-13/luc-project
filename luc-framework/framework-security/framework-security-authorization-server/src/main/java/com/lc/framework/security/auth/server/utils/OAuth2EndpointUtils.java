 ...
 */
package com.lc.framework.security.auth.server.utils;
 ...
 * 从org.springframework.security.oauth2.server.authorization.web包中抽离出来
 * @author Joe Grandja
 * @since 0.1.2
 */
public final class OAuth2EndpointUtils {
    ...
    public static OAuth2AuthenticationException oauth2Error(String errorCode, String parameterName, String errorUri) {
        OAuth2Error error = new OAuth2Error(errorCode, "OAuth 2.0 Parameter: " + parameterName, errorUri);
