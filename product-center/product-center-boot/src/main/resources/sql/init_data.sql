...
-- CVM 云服务器 SKU
('DEFAULT', 'CVM-S5-1C1G', '通用型S5 1核1G', '20260205084700', 'INSTANCE', 0.6000, 'CNY', 1, 1, 100, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CVM-S5-2C4G', '通用型S5 2核4G', '20260205084700', 'INSTANCE', 1.6000, 'CNY', 1, 1, 100, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CVM-S5-4C8G', '通用型S5 4核8G', '20260205084700', 'INSTANCE', 3.2000, 'CNY', 1, 1, 50, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CVM-S5-8C16G', '通用型S5 8核16G', '20260205084700', 'INSTANCE', 6.4000, 'CNY', 1, 1, 20, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CVM-C6-4C8G', '计算型C6 4核8G', '20260205084700', 'INSTANCE', 2.7200, 'CNY', 1, 1, 50, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CVM-C6-8C16G', '计算型C6 8核16G', '20260205084700', 'INSTANCE', 5.4400, 'CNY', 1, 1, 20, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),

-- CBS 云硬盘 SKU
('DEFAULT', 'CBS-SSD-100G', 'SSD云盘 100GB', '20260205084700', 'ADDON', 0.1000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CBS-SSD-500G', 'SSD云盘 500GB', '20260205084700', 'ADDON', 0.5000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CBS-PREMIUM-100G', '高效云盘 100GB', '20260205084700', 'ADDON', 0.0400, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CBS-PREMIUM-500G', '高效云盘 500GB', '20260205084700', 'ADDON', 0.2000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CBS-HDD-500G', 'HDD云盘 500GB', '20260205084700', 'ADDON', 0.0300, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),

-- CLB 负载均衡 SKU
('DEFAULT', 'CLB-PUBLIC-STANDARD', '公网负载均衡标准版', '20260205084700', 'INSTANCE', 0.0280, 'CNY', 1, 1, 20, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'CLB-PRIVATE-STANDARD', '内网负载均衡标准版', '20260205084700', 'INSTANCE', 0.0100, 'CNY', 1, 1, 50, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),

-- EIP 弹性公网IP SKU
('DEFAULT', 'EIP-BGP-1M', '弹性公网IP BGP 1Mbps', '20260205084700', 'ADDON', 0.0300, 'CNY', 1, 1, 20, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'EIP-BGP-5M', '弹性公网IP BGP 5Mbps', '20260205084700', 'ADDON', 0.1500, 'CNY', 1, 1, 20, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),

-- NAT 网关 SKU
('DEFAULT', 'NAT-SMALL', 'NAT网关 小型', '20260205084700', 'INSTANCE', 0.0500, 'CNY', 1, 1, 10, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'NAT-MEDIUM', 'NAT网关 中型', '20260205084700', 'INSTANCE', 0.1000, 'CNY', 1, 1, 5, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'NAT-LARGE', 'NAT网关 大型', '20260205084700', 'INSTANCE', 0.2000, 'CNY', 1, 1, 3, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),

-- APP_SUBSCRIPTION 应用订阅 SKU
('DEFAULT', 'APP-BASIC-MONTHLY', '应用基础版 月付', '20260205084700', 'SUBSCRIPTION', 99.0000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'APP-BASIC-YEARLY', '应用基础版 年付', '20260205084700', 'SUBSCRIPTION', 948.0000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'APP-PRO-MONTHLY', '应用专业版 月付', '20260205084700', 'SUBSCRIPTION', 299.0000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'APP-PRO-YEARLY', '应用专业版 年付', '20260205084700', 'SUBSCRIPTION', 2868.0000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'APP-ENT-MONTHLY', '应用企业版 月付', '20260205084700', 'SUBSCRIPTION', 999.0000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW()),
('DEFAULT', 'APP-ENT-YEARLY', '应用企业版 年付', '20260205084700', 'SUBSCRIPTION', 9588.0000, 'CNY', 1, 1, NULL, 1, NOW(), NULL, 'ACTIVE', NOW(), 'system', NOW());
...
('DEFAULT', 'CVM-S5-1C1G', '20260205084700', 'CVM', 'S5_GENERAL', 'CPU', 'INTEL', 1.00, 1, 'system', NOW()),
('DEFAULT', 'CVM-S5-1C1G', '20260205084700', 'CVM', 'S5_GENERAL', 'MEMORY', 'DDR4', 1.00, 1, 'system', NOW()),

-- CVM-S5-2C4G: 2核CPU + 4GB内存
('DEFAULT', 'CVM-S5-2C4G', '20260205084700', 'CVM', 'S5_GENERAL', 'CPU', 'INTEL', 2.00, 1, 'system', NOW()),
('DEFAULT', 'CVM-S5-2C4G', '20260205084700', 'CVM', 'S5_GENERAL', 'MEMORY', 'DDR4', 4.00, 1, 'system', NOW()),

-- CVM-S5-4C8G: 4核CPU + 8GB内存
('DEFAULT', 'CVM-S5-4C8G', '20260205084700', 'CVM', 'S5_GENERAL', 'CPU', 'INTEL', 4.00, 1, 'system', NOW()),
('DEFAULT', 'CVM-S5-4C8G', '20260205084700', 'CVM', 'S5_GENERAL', 'MEMORY', 'DDR4', 8.00, 1, 'system', NOW()),

-- CVM-S5-8C16G: 8核CPU + 16GB内存
('DEFAULT', 'CVM-S5-8C16G', '20260205084700', 'CVM', 'S5_GENERAL', 'CPU', 'INTEL', 8.00, 1, 'system', NOW()),
('DEFAULT', 'CVM-S5-8C16G', '20260205084700', 'CVM', 'S5_GENERAL', 'MEMORY', 'DDR4', 16.00, 1, 'system', NOW()),

-- CVM-C6-4C8G: 4核海光CPU + 8GB内存
('DEFAULT', 'CVM-C6-4C8G', '20260205084700', 'CVM', 'C6_COMPUTE', 'CPU', 'HYGON', 4.00, 1, 'system', NOW()),
('DEFAULT', 'CVM-C6-4C8G', '20260205084700', 'CVM', 'C6_COMPUTE', 'MEMORY', 'DDR4', 8.00, 1, 'system', NOW()),

-- CVM-C6-8C16G: 8核海光CPU + 16GB内存
('DEFAULT', 'CVM-C6-8C16G', '20260205084700', 'CVM', 'C6_COMPUTE', 'CPU', 'HYGON', 8.00, 1, 'system', NOW()),
('DEFAULT', 'CVM-C6-8C16G', '20260205084700', 'CVM', 'C6_COMPUTE', 'MEMORY', 'DDR4', 16.00, 1, 'system', NOW()),

-- CBS-SSD-100G
('DEFAULT', 'CBS-SSD-100G', '20260205084700', 'CBS', 'CLOUD_SSD', 'STORAGE', 'SSD', 100.00, 1, 'system', NOW()),

-- CBS-SSD-500G
('DEFAULT', 'CBS-SSD-500G', '20260205084700', 'CBS', 'CLOUD_SSD', 'STORAGE', 'SSD', 500.00, 1, 'system', NOW()),

-- CBS-PREMIUM-100G
('DEFAULT', 'CBS-PREMIUM-100G', '20260205084700', 'CBS', 'CLOUD_PREMIUM', 'STORAGE', 'HDD', 100.00, 1, 'system', NOW()),

-- CBS-PREMIUM-500G
('DEFAULT', 'CBS-PREMIUM-500G', '20260205084700', 'CBS', 'CLOUD_PREMIUM', 'STORAGE', 'HDD', 500.00, 1, 'system', NOW()),

-- CBS-HDD-500G
('DEFAULT', 'CBS-HDD-500G', '20260205084700', 'CBS', 'CLOUD_HDD', 'STORAGE', 'HDD', 500.00, 1, 'system', NOW()),

-- CLB-PUBLIC-STANDARD: 公网LB实例费 + 带宽费 + LCU费
('DEFAULT', 'CLB-PUBLIC-STANDARD', '20260205084700', 'CLB', 'PUBLIC_CLB', 'INSTANCE', 'CLB_STANDARD', 1.00, 1, 'system', NOW()),
('DEFAULT', 'CLB-PUBLIC-STANDARD', '20260205084700', 'CLB', 'PUBLIC_CLB', 'BANDWIDTH', 'BW_SHARED', 1.00, 0, 'system', NOW()),
('DEFAULT', 'CLB-PUBLIC-STANDARD', '20260205084700', 'CLB', 'PUBLIC_CLB', 'LCU', 'LCU_STANDARD', 1.00, 0, 'system', NOW()),

-- CLB-PRIVATE-STANDARD: 内网LB实例费
('DEFAULT', 'CLB-PRIVATE-STANDARD', '20260205084700', 'CLB', 'PRIVATE_CLB', 'INSTANCE', 'CLB_INTERNAL', 1.00, 1, 'system', NOW()),

-- EIP-BGP-1M: 带宽费
('DEFAULT', 'EIP-BGP-1M', '20260205084700', 'EIP', 'BGP', 'BANDWIDTH', 'BGP_BW', 1.00, 1, 'system', NOW()),

-- EIP-BGP-5M: 带宽费
('DEFAULT', 'EIP-BGP-5M', '20260205084700', 'EIP', 'BGP', 'BANDWIDTH', 'BGP_BW', 5.00, 1, 'system', NOW()),

-- NAT-SMALL
('DEFAULT', 'NAT-SMALL', '20260205084700', 'NAT', 'NAT_GATEWAY', 'INSTANCE', 'NAT_SMALL', 1.00, 1, 'system', NOW()),

-- NAT-MEDIUM
('DEFAULT', 'NAT-MEDIUM', '20260205084700', 'NAT', 'NAT_GATEWAY', 'INSTANCE', 'NAT_MEDIUM', 1.00, 1, 'system', NOW()),

-- NAT-LARGE
('DEFAULT', 'NAT-LARGE', '20260205084700', 'NAT', 'NAT_GATEWAY', 'INSTANCE', 'NAT_LARGE', 1.00, 1, 'system', NOW()),

-- APP-BASIC-MONTHLY
('DEFAULT', 'APP-BASIC-MONTHLY', '20260205084700', 'APP_SUBSCRIPTION', 'BASIC', 'SUBSCRIPTION', 'MONTHLY', 1.00, 1, 'system', NOW()),

-- APP-BASIC-YEARLY
('DEFAULT', 'APP-BASIC-YEARLY', '20260205084700', 'APP_SUBSCRIPTION', 'BASIC', 'SUBSCRIPTION', 'YEARLY', 12.00, 1, 'system', NOW()),

-- APP-PRO-MONTHLY
('DEFAULT', 'APP-PRO-MONTHLY', '20260205084700', 'APP_SUBSCRIPTION', 'PROFESSIONAL', 'SUBSCRIPTION', 'MONTHLY', 1.00, 1, 'system', NOW()),

-- APP-PRO-YEARLY
('DEFAULT', 'APP-PRO-YEARLY', '20260205084700', 'APP_SUBSCRIPTION', 'PROFESSIONAL', 'SUBSCRIPTION', 'YEARLY', 12.00, 1, 'system', NOW()),

-- APP-ENT-MONTHLY
('DEFAULT', 'APP-ENT-MONTHLY', '20260205084700', 'APP_SUBSCRIPTION', 'ENTERPRISE', 'SUBSCRIPTION', 'MONTHLY', 1.00, 1, 'system', NOW()),

-- APP-ENT-YEARLY
('DEFAULT', 'APP-ENT-YEARLY', '20260205084700', 'APP_SUBSCRIPTION', 'ENTERPRISE', 'SUBSCRIPTION', 'YEARLY', 12.00, 1, 'system', NOW());
...
-- 按量计费 - 按小时
('DEFAULT', 'PAY_AS_GO_HOURLY', '20260205084700', 'BY_USAGE', 'POSTPAID', 'HOURLY', 1, 'PERIOD', 'PRO_RATA', 1.0000, 'CNY', '小时', 2, NOW(), NULL, 1, 10, 'ACTIVE', '按量计费-按小时', 'system', NOW()),

-- 包月
('DEFAULT', 'PREPAID_MONTHLY', '20260205084700', 'BY_QUOTA', 'PREPAID', 'MONTHLY', 1, 'PERIOD', 'PRO_RATA', 0.8500, 'CNY', '月', 0, NOW(), NULL, 1, 20, 'ACTIVE', '包月(85折)', 'system', NOW()),

-- 包季
('DEFAULT', 'PREPAID_QUARTERLY', '20260205084700', 'BY_QUOTA', 'PREPAID', 'QUARTERLY', 1, 'PERIOD', 'PRO_RATA', 0.8000, 'CNY', '季度', 0, NOW(), NULL, 1, 30, 'ACTIVE', '包季(8折)', 'system', NOW()),

-- 包年
('DEFAULT', 'PREPAID_YEARLY', '20260205084700', 'BY_QUOTA', 'PREPAID', 'YEARLY', 1, 'PERIOD', 'PRO_RATA', 0.7000, 'CNY', '年', 0, NOW(), NULL, 1, 40, 'ACTIVE', '包年(7折)', 'system', NOW()),

-- 订阅-月付
('DEFAULT', 'SUBSCRIPTION_MONTHLY', '20260205084700', 'BY_QUOTA', 'SUBSCRIPTION', 'MONTHLY', 1, 'PERIOD', 'NON_REFUNDABLE', 1.0000, 'CNY', '月', 0, NOW(), NULL, 1, 50, 'ACTIVE', '月度订阅', 'system', NOW()),

-- 订阅-年付
('DEFAULT', 'SUBSCRIPTION_YEARLY', '20260205084700', 'BY_QUOTA', 'SUBSCRIPTION', 'YEARLY', 1, 'PERIOD', 'NON_REFUNDABLE', 0.8000, 'CNY', '年', 0, NOW(), NULL, 1, 60, 'ACTIVE', '年度订阅(8折)', 'system', NOW()),

-- 阶梯计费 - CPU (按量)
('DEFAULT', 'TIERED_CPU', '20260205084700', 'BY_USAGE', 'POSTPAID', 'HOURLY', 1, 'QUANTITY', 'PRO_RATA', 1.0000, 'CNY', '核·小时', 4, NOW(), NULL, 1, 100, 'ACTIVE', 'CPU阶梯计费', 'system', NOW()),

-- 流量计费
('DEFAULT', 'TRAFFIC_PAY_AS_GO', '20260205084700', 'BY_USAGE', 'POSTPAID', 'ONCE', 1, 'QUANTITY', 'NON_REFUNDABLE', 1.0000, 'CNY', 'GB', 6, NOW(), NULL, 1, 70, 'ACTIVE', '流量按量计费', 'system', NOW());
...
('DEFAULT', 'CVM-S5-1C1G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-1C1G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-1C1G', '20260205084700', 'PREPAID_YEARLY', '20260205084700', 8760.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-S5-2C4G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-2C4G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-2C4G', '20260205084700', 'PREPAID_YEARLY', '20260205084700', 8760.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-S5-4C8G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-4C8G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-4C8G', '20260205084700', 'PREPAID_YEARLY', '20260205084700', 8760.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-S5-8C16G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-8C16G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-8C16G', '20260205084700', 'PREPAID_YEARLY', '20260205084700', 8760.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-C6-4C8G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-C6-4C8G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-C6-4C8G', '20260205084700', 'PREPAID_YEARLY', '20260205084700', 8760.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-C6-8C16G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-C6-8C16G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-C6-8C16G', '20260205084700', 'PREPAID_YEARLY', '20260205084700', 8760.0000, 0, 'ACTIVE', 'system', NOW()),

-- CBS SKU 关联定价 (按量/包月)
('DEFAULT', 'CBS-SSD-100G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-SSD-100G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CBS-SSD-500G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-SSD-500G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CBS-PREMIUM-100G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-PREMIUM-100G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CBS-PREMIUM-500G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-PREMIUM-500G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CBS-HDD-500G', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-HDD-500G', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

-- CLB SKU 关联定价 (按量/包月)
('DEFAULT', 'CLB-PUBLIC-STANDARD', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CLB-PUBLIC-STANDARD', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CLB-PRIVATE-STANDARD', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CLB-PRIVATE-STANDARD', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

-- EIP SKU 关联定价 (按量)
('DEFAULT', 'EIP-BGP-1M', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'EIP-BGP-5M', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),

-- NAT SKU 关联定价 (按量/包月)
('DEFAULT', 'NAT-SMALL', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'NAT-SMALL', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'NAT-MEDIUM', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'NAT-MEDIUM', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'NAT-LARGE', '20260205084700', 'PAY_AS_GO_HOURLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'NAT-LARGE', '20260205084700', 'PREPAID_MONTHLY', '20260205084700', 720.0000, 0, 'ACTIVE', 'system', NOW()),

-- APP 订阅 SKU 关联定价 (订阅)
('DEFAULT', 'APP-BASIC-MONTHLY', '20260205084700', 'SUBSCRIPTION_MONTHLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'APP-BASIC-YEARLY', '20260205084700', 'SUBSCRIPTION_YEARLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'APP-PRO-MONTHLY', '20260205084700', 'SUBSCRIPTION_MONTHLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'APP-PRO-YEARLY', '20260205084700', 'SUBSCRIPTION_YEARLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'APP-ENT-MONTHLY', '20260205084700', 'SUBSCRIPTION_MONTHLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'APP-ENT-YEARLY', '20260205084700', 'SUBSCRIPTION_YEARLY', '20260205084700', 1.0000, 1, 'ACTIVE', 'system', NOW());
...
('DEFAULT', 'CVM-S5-1C1G', '20260205084700', 'TIERED_CPU_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-1C1G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-S5-2C4G', '20260205084700', 'TIERED_CPU_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-2C4G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-S5-4C8G', '20260205084700', 'TIERED_CPU_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-4C8G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-S5-8C16G', '20260205084700', 'TIERED_CPU_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-S5-8C16G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-C6-4C8G', '20260205084700', 'TIERED_CPU_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-C6-4C8G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CVM-C6-8C16G', '20260205084700', 'TIERED_CPU_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CVM-C6-8C16G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

-- CBS SKU 关联存储阶梯策略和批量折扣
('DEFAULT', 'CBS-SSD-100G', '20260205084700', 'TIERED_STORAGE_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-SSD-100G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

('DEFAULT', 'CBS-SSD-500G', '20260205084700', 'TIERED_STORAGE_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-SSD-500G', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),


('DEFAULT', 'CBS-PREMIUM-100G', '20260205084700', 'TIERED_STORAGE_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-PREMIUM-500G', '20260205084700', 'TIERED_STORAGE_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CBS-HDD-500G', '20260205084700', 'TIERED_STORAGE_001', 100, NULL, NULL, 'ACTIVE', 'system', NOW()),

-- CLB SKU 关联批量折扣
('DEFAULT', 'CLB-PUBLIC-STANDARD', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'CLB-PRIVATE-STANDARD', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),

-- NAT SKU 关联批量折扣
('DEFAULT', 'NAT-SMALL', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'NAT-MEDIUM', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW()),
('DEFAULT', 'NAT-LARGE', '20260205084700', 'VOLUME_DISCOUNT_001', 50, NULL, NULL, 'ACTIVE', 'system', NOW());
